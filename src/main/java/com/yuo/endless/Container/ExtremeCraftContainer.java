...
public class ExtremeCraftContainer extends RecipeBookMenu<CraftingContainer> {
    ...
    private CraftingContainer getCraftingInv(){
        TransientCraftingContainer inventory = new TransientCraftingContainer(new CraftMenu(MenuType.CRAFTING, containerId), 3, 3);
    ...
    public static class CraftMenu extends AbstractContainerMenu {

        public CraftMenu(@Nullable MenuType<?> p_38851_, int p_38852_) {
