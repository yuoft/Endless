...
import com.yuo.endless.Container.ExtremeCraftContainer.CraftMenu;
...
//        this.chestTile.clearContent();
    ...
    public CraftingContainer getCraftingInv(){
        TransientCraftingContainer inventory = new TransientCraftingContainer(new CraftMenu(MenuType.CRAFTING, this.containerId), 3, 3);
