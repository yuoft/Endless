...
//    public static final ResourceLocation OVERLAY_OIL_TEXTURE = ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "block/fluids/fluid_overlay");
    ...
    public static ForgeFlowingFluid.Properties INFINITY_PRO = new ForgeFlowingFluid.Properties(
            //材质，颜色，亮度，流体密度,温度,稠度,稀有度
            () -> InfinityFluid.setAttr(STILL_OIL_TEXTURE, FLOWING_OIL_TEXTURE, 0xff333333), infinityFluid, infinityFluidFlowing)
            //流体桶,流体方块,流体消失速度，防爆性
