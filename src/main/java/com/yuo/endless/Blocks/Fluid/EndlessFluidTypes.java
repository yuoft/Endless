...
public class EndlessFluidTypes {
    public static final ResourceLocation STILL_OIL_TEXTURE = EndlessUtils.fa("block/fluids/fluid");
    public static final ResourceLocation FLOWING_OIL_TEXTURE = EndlessUtils.fa("block/fluids/fluid_flow");
    public static final ResourceLocation OVERLAY_OIL_TEXTURE = EndlessUtils.fa("block/fluids/fluid_overlay");
