    ...
    public Component getName(ItemStack stack) {
        ...
        if (nbt != null){
            ...
            if (Config.customSingularities.contains(type)){
                ...
                return Component.translatable(s + " Singularity").withStyle(ChatFormatting.YELLOW);
            }
            return Component.translatable(this.getDescriptionId() + "_" + type);
        }
...
//    }
    ...
    public void appendHoverText(ItemStack stack, @org.jetbrains.annotations.Nullable Level level, List<Component> components, TooltipFlag pIsAdvanced) {
        ...
        if (nbt != null){
            String type = nbt.getString(NBT_TYPE);
            if ("clay".equals(type)){
                components.add(Component.keybind(ColorText.makeSANIC(I18n.get("endless.text.itemInfo.singularity_clay"))));
            }
