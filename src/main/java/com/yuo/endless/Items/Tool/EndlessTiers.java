...
public class EndlessTiers {
    public static final TagKey<Block> NEEDS_CRYSTAL_TOOL = BlockTags.create(ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "needs_crystal_tool"));
    public static final TagKey<Block> NEEDS_NEUTRON_TOOL = BlockTags.create(ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "needs_neutron_tool"));
    public static final TagKey<Block> NEEDS_INFINITY_TOOL = BlockTags.create(ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "needs_infinity_tool"));
    ...
    public static Tier INFINITY_TOOL = TierSortingRegistry.registerTier(new ForgeTier(9999,9999, Float.MAX_VALUE,10, 99, NEEDS_INFINITY_TOOL,
            () -> Ingredient.of(EndlessItems.infinityIngot.get())),ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "infinity_tool"),
    ...
    public static Tier INFINITY_SWORD = TierSortingRegistry.registerTier(new ForgeTier(9999, 9999, 999, Float.POSITIVE_INFINITY, 99,  NEEDS_INFINITY_TOOL,
            () -> Ingredient.of(EndlessItems.infinityIngot.get())),ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "infinity_sword"),
            List.of(NEUTRON), List.of());
