...
public class MyFoods {
    ...
    public static final FoodProperties STEW = new FoodProperties.Builder().nutrition(50).saturationMod(30).effect(
            () -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, (int) Math.ceil(5 * 60 * 20 * Config.SERVER.foodTime.get()), 0), 1).effect(
            () -> new MobEffectInstance(MobEffects.FIRE_RESISTANCE, (int) Math.ceil(1 * 60 * 20 * Config.SERVER.foodTime.get()), 1), 1).effect(
            () -> new MobEffectInstance(MobEffects.ABSORPTION, (int) Math.ceil(3 * 60 * 20 * Config.SERVER.foodTime.get()), 2), 1).effect(
            () -> new MobEffectInstance(MobEffects.NIGHT_VISION, (int) Math.ceil(3 * 60 * 20 * Config.SERVER.foodTime.get()), 0), 1).effect(
            () -> new MobEffectInstance(MobEffects.WATER_BREATHING, (int) Math.ceil(2 * 60 * 20 * Config.SERVER.foodTime.get()), 2), 1).effect(
            () -> new MobEffectInstance(MobEffects.REGENERATION, (int) Math.ceil(5 * 60 * 20 * Config.SERVER.foodTime.get()), 4), 1).alwaysEat().build();
}
