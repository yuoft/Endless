...
public class EndlessItems {
	...
	//盔甲
	public static RegistryObject<ArmorItem> infinityHead = ITEMS.register("infinity_helmet", () -> new InfinityArmor(Type.HELMET));
	public static RegistryObject<ArmorItem> infinityChest = ITEMS.register("infinity_chestplate", () -> new InfinityArmor(Type.CHESTPLATE));
	public static RegistryObject<ArmorItem> infinityLegs = ITEMS.register("infinity_leggings", () -> new InfinityArmor(Type.LEGGINGS));
	public static RegistryObject<ArmorItem> infinityFeet = ITEMS.register("infinity_boots", () -> new InfinityArmor(Type.BOOTS));
	public static RegistryObject<ArmorItem> crystalMatrixHead = ITEMS.register("crystal_matrix_helmet", () -> new CrystalMatrixArmor(EndlessArmorMaterials.CRYSTAL, Type.HELMET));
	public static RegistryObject<ArmorItem> crystalMatrixChest = ITEMS.register("crystal_matrix_chestplate", () -> new CrystalMatrixArmor(EndlessArmorMaterials.CRYSTAL, Type.CHESTPLATE));
	public static RegistryObject<ArmorItem> crystalMatrixLegs = ITEMS.register("crystal_matrix_leggings", () -> new CrystalMatrixArmor(EndlessArmorMaterials.CRYSTAL, Type.LEGGINGS));
	public static RegistryObject<ArmorItem> crystalMatrixFeet = ITEMS.register("crystal_matrix_boots", () -> new CrystalMatrixArmor(EndlessArmorMaterials.CRYSTAL, Type.BOOTS));
	public static RegistryObject<ArmorItem> neutroniumHead = ITEMS.register("neutronium_helmet", () -> new NeutroniumArmor(EndlessArmorMaterials.NEUTRON, Type.HELMET));
	public static RegistryObject<ArmorItem> neutroniumChest = ITEMS.register("neutronium_chestplate", () -> new NeutroniumArmor(EndlessArmorMaterials.NEUTRON, Type.CHESTPLATE));
	public static RegistryObject<ArmorItem> neutroniumLegs = ITEMS.register("neutronium_leggings", () -> new NeutroniumArmor(EndlessArmorMaterials.NEUTRON, Type.LEGGINGS));
	public static RegistryObject<ArmorItem> neutroniumFeet = ITEMS.register("neutronium_boots", () -> new NeutroniumArmor(EndlessArmorMaterials.NEUTRON, Type.BOOTS));


	//注册方块物品
	public static RegistryObject<BlockItem> infinityBlock = ITEMS.register("infinity_block",
			() -> new BlockItem(EndlessBlocks.infinityBlock.get(), BLOCK_TAB.fireResistant()));
	...
	public static RegistryObject<BlockItem> extremeCraftingTable = ITEMS.register("extreme_crafting_table",
			() -> new BlockItem(EndlessBlocks.extremeCraftingTable.get(), BLOCK_TAB.fireResistant()));
	...
	public static RegistryObject<BlockItem> densestNeutroniumCollector = ITEMS.register("densest_neutronium_collector",
			() -> new BlockItem(EndlessBlocks.densestNeutroniumCollector.get(), BLOCK_TAB.fireResistant()));
