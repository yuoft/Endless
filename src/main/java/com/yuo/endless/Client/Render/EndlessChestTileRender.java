...
public class EndlessChestTileRender implements BlockEntityRenderer<AbsEndlessChestTile> {
    ...
    @Override
    public void render(AbsEndlessChestTile chest, float pPartialTick, PoseStack pPoseStack, MultiBufferSource source, int pPackedLight, int pPackedOverlay) {
        ...
        if (block instanceof AbsEndlessChest absEndlessChest) {
            ...
            VertexConsumer vertexconsumer = material.buffer(source, RenderType::entityCutout);
