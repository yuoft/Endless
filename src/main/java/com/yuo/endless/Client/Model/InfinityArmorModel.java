...
public class InfinityArmorModel extends HumanoidModel<Player> {
    public static ResourceLocation MASK = RlUtils.fa("models/infinity_armor_mask");
    public static ResourceLocation MASK_INV = RlUtils.fa("models/infinity_armor_mask_inv");
    public static ResourceLocation WING = RlUtils.fa("models/infinity_armor_mask_wings");
    private static boolean modelRender;
    private static boolean playerFlying;
    private static boolean player;
    private final ResourceLocation eyeTex = RlUtils.fa("textures/models/infinity_armor_eyes.png");
    private final ResourceLocation wingTex = RlUtils.fa("textures/models/infinity_armor_wing.png");
    private final ResourceLocation wingGlowTex = RlUtils.fa("textures/models/infinity_armor_wingglow.png");
