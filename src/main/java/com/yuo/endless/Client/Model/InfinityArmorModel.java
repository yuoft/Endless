...
public class InfinityArmorModel extends HumanoidModel<Player> {
    public static ResourceLocation MASK = ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "models/infinity_armor_mask");
    public static ResourceLocation MASK_INV = ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "models/infinity_armor_mask_inv");
    public static ResourceLocation WING = ResourceLocation.fromNamespaceAndPath(Endless.MOD_ID, "models/infinity_armor_mask_wings");
