...
//        public final ForgeConfigSpec.IntValue singularityPlatinum;
        ...
        public ServerConfig(ForgeConfigSpec.Builder builder){
            ...
            this.singularityCoal = buildInt(builder, "Coal", 450, 10, 10000, "base count");
            this.singularityClay = buildInt(builder, "Clay", 400, 10, 10000, "base count");
            this.singularityIron = buildInt(builder, "Iron", 300, 10, 10000, "base count");
            this.singularityGold = buildInt(builder, "Gold", 350, 10, 10000, "base count");
            this.singularityDiamond = buildInt(builder, "Diamond", 250, 10, 10000, "base count");
            this.singularityEmerald = buildInt(builder, "Emerald", 200, 10, 10000, "base count");
            this.singularityNetherite = buildInt(builder, "Netherite", 150, 10, 10000, "base count");
            this.singularityLapis = buildInt(builder, "Lapis", 400, 10, 10000, "base count");
            this.singularityQuartz = buildInt(builder, "Quartz", 500, 10, 10000, "base count");
            this.singularityRedstone = buildInt(builder, "Redstone", 400, 10, 10000, "base count");
            this.singularitySilver = buildInt(builder, "Silver", 200, 10, 10000, "base count");
            this.singularityCopper = buildInt(builder, "Copper", 300, 10, 10000, "base count");
            this.singularityRuby = buildInt(builder, "Ruby", 250, 10, 10000, "base count");
            this.singularityDragon = buildInt(builder, "Dragon", 100, 10, 10000, "base count");
            this.singularitySpace = buildInt(builder, "Space", 50, 10, 10000, "base count");
            this.singularityXray = buildInt(builder, "Xray", 150, 10, 10000, "base count");
            this.singularityUltra = buildInt(builder, "Ultra", 80, 10, 10000, "base count");
            this.singularityZinc = buildInt(builder, "Zinc", 300, 10, 10000, "base count");
//            this.singularityPlatinum = buildInt(builder, "Platinum", 200, 10, 2000, "base count");
            this.singularityNickel = buildInt(builder, "Nickel", 400, 10, 10000, "base count");
            this.singularityLead = buildInt(builder, "Lead", 300, 10, 10000, "base count");
            this.singularityTin = buildInt(builder, "Tin", 400, 10, 10000, "base count");
            this.singularityDragonIum = buildInt(builder, "DragonIum", 80, 10, 10000, "base count");
            this.singularityAwakenDragon = buildInt(builder, "AwakenDragon", 10, 10, 10000, "base count");
            this.singularityMana = buildInt(builder, "Mana", 200, 10, 10000, "base count");
            this.singularityTara = buildInt(builder, "Tara", 100, 10, 10000, "base count");
            this.singularityElementIum = buildInt(builder, "ElementIum", 50, 10, 10000, "base count");
            this.singularityDarkMatter = buildInt(builder, "Dark Matter", 150, 10, 10000, "base count");
            this.singularityRedMatter = buildInt(builder, "Red Matter", 100, 10, 10000, "base count");
            this.singularityCobalt = buildInt(builder, "Cobalt", 150, 10, 10000, "base count");
            this.singularityManyullyn = buildInt(builder, "Manyullyn", 100, 10, 10000, "base count");
            builder.pop();
            ...
            this.modRatioCount = buildInt(builder, "Mod Ratio Count", 2000, 500, 10000, "Maximum addition of the amount of singularities affected by other mods.");
            builder.pop();
