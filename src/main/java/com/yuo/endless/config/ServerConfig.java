...
public class ServerConfig {
    ...
    public final ForgeConfigSpec.BooleanValue mobHpInfo; //无尽生物是否显示Boss血条
    public final ForgeConfigSpec.BooleanValue swordKill; //无尽剑是否开启额外攻击代码
    ...
    public final ForgeConfigSpec.IntValue infinityArmorBearDamage; //无尽武器攻击全套无尽装备玩家时，造成的伤害值
    public final ForgeConfigSpec.IntValue infinityBearDamage; //无尽武器攻击全套无尽装备和持有无尽武器玩家时，造成的伤害值
    ...
    */
    ...
    public final ConfigValue<List<String>> shovelBlackList;
    public final ConfigValue<List<String>> hoeBlackList;

    public final ConfigValue<List<String>> singularityCustomList; //自定义奇点
...
//            this.singularityPlatinum = buildInt(builder, "Platinum", 200, 10, 2000, "base count");
    ...
    private static ForgeConfigSpec.ConfigValue<List<String>> buildConfig(ForgeConfigSpec.Builder builder, String name, String comment) {
        return builder.comment(comment).define(name, Lists.newArrayList());
    }
