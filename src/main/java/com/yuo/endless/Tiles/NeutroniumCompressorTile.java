...
public class NeutroniumCompressorTile extends BaseContainerBlockEntity implements WorldlyContainer {
    ...
    protected Component getDefaultName() {
        return Component.translatable("gui.endless.neutron_compressor");
    }
    ...
    public void setItem(int index, ItemStack stack) {
        ...
        boolean flag = !stack.isEmpty() && stack.equals(itemstack, false) && ItemStack.isSameItem(stack, itemstack);
