...
public class ExtremeCraftTile extends BaseContainerBlockEntity {
    ...
    public void setItem(int index, ItemStack stack) {
        if (index == 81) reslut.set(0, stack);
            ...
            boolean flag = !stack.isEmpty() && stack.equals(itemstack, false) && ItemStack.isSameItem(stack, itemstack); //相同物品
    ...
    public Component getName() {
        return Component.translatable("gui.endless.extreme_crafting_table");
    }
