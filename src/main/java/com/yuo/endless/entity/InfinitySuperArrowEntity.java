...
public class InfinitySuperArrowEntity extends AbstractArrow {
    ...
    public void tick() {
        ...
        if (level.getGameTime() % 10 == 0) {
            ...
            level.explode(this.shooter, offset.getX(), offset.getY(), offset.getZ(), explosionLv, true, ExplosionInteraction.BLOCK);
            BlockPos offsetW = pos.relative(Direction.WEST, length);
            level.explode(this.shooter, offsetW.getX(), offsetW.getY(), offsetW.getZ(), explosionLv, true, ExplosionInteraction.BLOCK);
            BlockPos offsetS = pos.relative(Direction.SOUTH, length);
            level.explode(this.shooter, offsetS.getX(), offsetS.getY(), offsetS.getZ(), explosionLv, true, ExplosionInteraction.BLOCK);
            BlockPos offsetN = pos.relative(Direction.NORTH, length);
            level.explode(this.shooter, offsetN.getX(), offsetN.getY(), offsetN.getZ(), explosionLv, true, ExplosionInteraction.BLOCK);
            BlockPos offsetU = pos.relative(Direction.UP, length);
            level.explode(this.shooter, offsetU.getX(), offsetU.getY(), offsetU.getZ(), explosionLv, true, ExplosionInteraction.BLOCK);
            BlockPos offsetD = pos.relative(Direction.DOWN, length);
            level.explode(this.shooter, offsetD.getX(), offsetD.getY(), offsetD.getZ(), explosionLv, true, ExplosionInteraction.BLOCK);
        }
        ...
        for (BlockPos blockPos : allInBoxMutable) {
            ...
            if (b) {
                level.explode(this.shooter, blockPos.getX(), blockPos.getY(), blockPos.getZ(), 5.0f, true, ExplosionInteraction.BLOCK);
            }
