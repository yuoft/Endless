...
public class InfinityMobStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public InfinityMobStructure() {
        ...
        super(CODEC, InfinityMobStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!InfinityMobStructure.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            System.out.println("Error is Structure pieces generator found");
        }
