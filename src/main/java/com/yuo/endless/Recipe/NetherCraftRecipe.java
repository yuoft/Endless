...
public class NetherCraftRecipe implements IExtremeCraftRecipe {
    ...
    public NetherCraftRecipe(ResourceLocation id, int WidthIn, int HeightIn, NonNullList<Ingredient> itemsIn, ItemStack result){
        this.id = id;
        this.Width = WidthIn;
    ...
    public IRecipeType<?> getType() {
        return RecipeTypeRegistry.NETHER_CRAFT_RECIPE;
    }

    public static class RecipeType implements IRecipeType<NetherCraftRecipe> {
        @Override
        public String toString() {
            return NetherCraftRecipe.NETHER_TYPE_ID.toString();
        }
    }

    //配方序列器
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<NetherCraftRecipe>{
        @Override
        public NetherCraftRecipe read(ResourceLocation recipeId, JsonObject json) { //从json中获取信息
            ...
            return new NetherCraftRecipe(recipeId, i, j, nonnulllist, result);
        }

        @Nullable
        @Override
        public NetherCraftRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
        ...
        @Override
        public void write(PacketBuffer buffer, NetherCraftRecipe recipe) {
    ...
    public IRecipeSerializer<?> getSerializer() {
        return RecipeTypeRegistry.NETHER_CRAFT_SERIALIZER.get();
    }
